...
public class Ship
{
    ...
    //L: the ship's hitstaken will plus 1//
    public void Hit()
    {
        _hitsTaken++;
    }
    ...
    //L: IsDestroyed return if the ships is destroyed//
    ...
    //L: Deployed sets the ships direction and location by using row, col and direction//
