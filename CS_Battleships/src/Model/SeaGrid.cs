...
public class SeaGrid : ISeaGrid
{
    ...
    private tile[,] _gametiles = new tile[9, 9]; // must be fixed for code to compile
    ...
    // public tile[,] Gametiles { get => Gametiles1; set => Gametiles1 = value; }
    // public tile[,] Gametiles1 { get => _gametiles; set => _gametiles = value; }

    public TileView this[int x, int y]
    {
        get
        {
            return _gametiles[x, y].View; // have to get this fixed. I made the declaration as well, maybe that needs changing
        }
    }

    // Endclass Unknown { //no idea what the hell we do here? What was the purpose of this function
    // }
