...
public class SeaGrid : ISeaGrid
{
    ...
    public event EventHandler Changed
    {
        add
        {
            ChangedEvent = (EventHandler) System.Delegate.Combine(ChangedEvent, value);
        }
        remove
        {
            ChangedEvent = (EventHandler) System.Delegate.Remove(ChangedEvent, value);
        }
    }
    ...
    public AttackResult HitTile(int row, int col)
    {
        try
        {
            ...
            {
                return new AttackResult(ResultOfAttack.ShotAlready, "have already attacked [" + System.Convert.ToString(col + 1) + "," + System.Convert.ToString(row + 1) + "]!", row, col);
            }
